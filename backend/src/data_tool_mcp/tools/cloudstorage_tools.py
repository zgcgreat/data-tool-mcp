...
async def _gcs_create_bucket(source: CloudStorageSource, params: dict[str, Any]) -> dict[str, Any]:
    """创建Cloud Storage的存储桶。"""
    return {
        "bucket_name": await source.create_bucket(
            params["bucket_name"], params.get("location", "US")
        )
    }
...
async def _gcs_get_bucket_metadata(
    source: CloudStorageSource, params: dict[str, Any]
) -> dict[str, Any]:
    """获取Cloud Storage的存储桶元数据。"""
    return {"metadata": await source.get_bucket_metadata(params["bucket_name"])}


async def _gcs_get_bucket_iam_policy(
    source: CloudStorageSource, params: dict[str, Any]
) -> dict[str, Any]:
...
async def _gcs_download_object(
    source: CloudStorageSource, params: dict[str, Any]
) -> dict[str, Any]:
    """下载Cloud Storage的对象。"""
...
async def _gcs_copy_object(source: CloudStorageSource, params: dict[str, Any]) -> dict[str, Any]:
    """复制Cloud Storage的对象。"""
    await source.copy_object(
        params["src_bucket"], params["src_obj"], params["dst_bucket"], params["dst_obj"]
    )
    return {"copied": True}
...
async def _gcs_get_object_metadata(
    source: CloudStorageSource, params: dict[str, Any]
) -> dict[str, Any]:
...
class GCSGenericTool(BaseTool):
    ...
    async def invoke(
        ...
        source = await _get_typed_source_async(
            source_provider, self._source_name, self.name, CloudStorageSource
        )
        try:
...
_GCS_TOOLS: list[tuple[str, str, list[ParameterManifest], bool]] = [
    ...
    (
        ...
        [
            ...
            ParameterManifest(
                name="location", type="string", description="Bucket location", required=False
            ),
        ],
        False,
    ),
    ...
    (
        ...
        "Get metadata for a Cloud Storage bucket",
        [
            ParameterManifest(
                name="bucket_name", type="string", description="Bucket name", required=True
            )
    ...
    (
        ...
        "Get IAM policy for a Cloud Storage bucket",
        [
            ParameterManifest(
                name="bucket_name", type="string", description="Bucket name", required=True
            )
    ...
    (
        ...
        [
            ...
            ParameterManifest(
                name="prefix", type="string", description="Object prefix filter", required=False
            ),
        ],
        True,
    ),
    (
        ...
        [
            ...
            ParameterManifest(
                name="object_name", type="string", description="Object name", required=True
            ),
        ],
        True,
    ),
    ...
    (
        ...
        [
            ...
            ParameterManifest(
                name="dest_path",
                type="string",
                description="Local file path to download to",
                required=True,
            ),
        ],
        False,
    ...
    (
        ...
        "Copy an object in Cloud Storage",
        [
            ParameterManifest(
                name="src_bucket", type="string", description="Source bucket", required=True
            ),
            ParameterManifest(
                name="src_obj", type="string", description="Source object name", required=True
            ),
            ParameterManifest(
                name="dst_bucket", type="string", description="Destination bucket", required=True
            ),
            ParameterManifest(
                name="dst_obj", type="string", description="Destination object name", required=True
            ),
        ],
        False,
    ),
    (
        ...
        "Move an object in Cloud Storage",
        [
            ParameterManifest(
                name="src_bucket", type="string", description="Source bucket", required=True
            ),
