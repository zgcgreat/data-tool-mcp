...
async def _lk_get_explore(source: LookerSource, params: dict[str, Any]) -> dict[str, Any]:
    """获取Looker的探索。"""
    return {
        "explore": await source.get_lookml_explore(params["model_name"], params["explore_name"])
    }
...
async def _lk_fallback(source: LookerSource, params: dict[str, Any]) -> dict[str, Any]:
    """Looker 工具兜底处理。"""
    return {
        "tool_type": params.get("__tool_type", ""),
        "params": {k: v for k, v in params.items() if k != "__tool_type"},
        "note": "SDK method not yet mapped in LookerSource",
    }
...
class LookerGenericTool(BaseTool):
    ...
    async def invoke(
        ...
        source = await _get_typed_source_async(
            source_provider, self._source_name, self.name, LookerSource
        )
        try:
...
_LOOKER_TOOLS: list[tuple[str, str, list[ParameterManifest], bool]] = [
    ...
    (
        ...
        [
            ParameterManifest(
                name="model_name", type="string", description="Model name", required=True
            )
        ],
        True,
    ),
    ...
    (
        "looker-get-explore",
        "Get a LookML explore",
        [
            ParameterManifest(
                name="model_name", type="string", description="Model name", required=True
            ),
            ParameterManifest(
                name="explore_name", type="string", description="Explore name", required=True
            ),
        ],
        True,
    ),
    ...
    (
        ...
        [
            ParameterManifest(
                name="query_id", type="integer", description="Query ID", required=True
            ),
            ParameterManifest(
                name="result_format", type="string", description="Result format", required=False
            ),
        ],
        True,
    ),
    ...
    (
        ...
        "Get a Looker dashboard",
        [
            ParameterManifest(
                name="dashboard_id", type="string", description="Dashboard ID", required=True
            )
        ],
        True,
    ),
    ...
    (
        ...
        "List databases in a Looker connection",
        [
            ParameterManifest(
                name="connection_name", type="string", description="Connection name", required=True
            )
        ],
        True,
    ),
    (
        ...
        "List schemas in a Looker connection",
        [
            ParameterManifest(
                name="connection_name", type="string", description="Connection name", required=True
            )
    ...
    (
        ...
        "List tables in a Looker connection schema",
        [
            ParameterManifest(
                name="connection_name", type="string", description="Connection name", required=True
            ),
    ...
    (
        ...
        "List columns of a table in a Looker connection",
        [
            ParameterManifest(
                name="connection_name", type="string", description="Connection name", required=True
            ),
            ParameterManifest(name="table", type="string", description="Table name", required=True),
        ],
        True,
    ),
    # Explore metadata (4)
    ...
    (
        "looker-get-measures",
        "Get measures for a LookML explore",
        [
            ParameterManifest(
                name="model_name", type="string", description="Model name", required=True
            ),
    ...
    (
        "looker-get-filters",
        "Get filters for a LookML explore",
        [
            ParameterManifest(
                name="model_name", type="string", description="Model name", required=True
            ),
    ...
    (
        ...
        "Get parameters for a LookML explore",
        [
            ParameterManifest(
                name="model_name", type="string", description="Model name", required=True
            ),
    ...
    (
        ...
        "List files in a Looker project",
        [
            ParameterManifest(
    ...
    (
        ...
        "Get a file from a Looker project",
        [
            ParameterManifest(
                name="project_id", type="string", description="Project ID", required=True
            ),
    ...
    (
        ...
        "List directories in a Looker project",
        [
            ParameterManifest(
                name="project_id", type="string", description="Project ID", required=True
            )
    ...
    (
        ...
        "Create a file in a Looker project",
        [
            ParameterManifest(
                name="project_id", type="string", description="Project ID", required=True
            ),
            ParameterManifest(name="body", type="object", description="File body", required=True),
        ],
        False,
    ),
    (
        "looker-update-project-file",
        "Update a file in a Looker project",
        [
            ParameterManifest(
                name="project_id", type="string", description="Project ID", required=True
            ),
    ...
    (
        ...
        "Delete a file from a Looker project",
        [
            ParameterManifest(
                name="project_id", type="string", description="Project ID", required=True
            ),
    ...
    (
        ...
        "Create a directory in a Looker project",
        [
            ParameterManifest(
                name="project_id", type="string", description="Project ID", required=True
            ),
            ParameterManifest(
                name="directory_name", type="string", description="Directory name", required=True
            ),
        ],
        False,
    ),
    (
        ...
        "Delete a directory from a Looker project",
        [
            ParameterManifest(
                name="project_id", type="string", description="Project ID", required=True
            ),
    ...
    (
        ...
        [
            ...
            ParameterManifest(name="body", type="object", description="Branch body", required=True),
        ],
        False,
    ),
    (
        ...
        [
            ...
            ParameterManifest(
                name="branch_name", type="string", description="Branch name", required=True
            ),
        ],
        False,
    ),
    ...
    (
        "looker-dev-mode",
        "Toggle Looker dev mode",
        [
            ParameterManifest(
                name="enabled", type="boolean", description="Enable dev mode", required=True
            )
        ],
        False,
    ),
    ...
    (
        ...
        "Get LookML tests for a project",
        [
            ParameterManifest(
                name="project_id", type="string", description="Project ID", required=True
            )
    ...
    (
        "looker-make-look",
        "Create a Looker look",
        [ParameterManifest(name="body", type="object", description="Look body", required=True)],
        False,
    ),
    (
        ...
        [
            ParameterManifest(
                name="body", type="object", description="Dashboard body", required=True
            )
        ],
        False,
    ),
    (
        ...
        "Add an element to a Looker dashboard",
        [
            ParameterManifest(
                name="dashboard_id", type="string", description="Dashboard ID", required=True
            ),
            ParameterManifest(
                name="body", type="object", description="Element body", required=True
            ),
        ],
        False,
    ),
    (
        ...
        "Add a filter to a Looker dashboard",
        [
            ParameterManifest(
                name="dashboard_id", type="string", description="Dashboard ID", required=True
            ),
            ParameterManifest(name="body", type="object", description="Filter body", required=True),
        ],
        False,
    ),
    (
    ...
    (
        ...
        "Run conversational analytics in Looker",
        [
            ParameterManifest(
                name="question",
                type="string",
    ...
    (
        "looker-create-agent",
        "Create a Looker agent",
        [ParameterManifest(name="body", type="object", description="Agent body", required=True)],
        False,
    ),
    (
        "looker-get-agent",
    ...
    (
        ...
        "Create a LookML view from a database table",
        [
            ParameterManifest(
                name="connection_name", type="string", description="Connection name", required=True
            ),
    ...
    (
        "looker-query-url",
        "Get the URL for a Looker query",
        [ParameterManifest(name="query_id", type="integer", description="Query ID", required=True)],
        True,
    ),
    (
