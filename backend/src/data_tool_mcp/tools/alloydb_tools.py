...
async def _al_create_instance(source: AlloyDBAdminSource, params: dict[str, Any]) -> dict[str, Any]:
    """创建AlloyDB的实例。"""
    return {
        "result": await source.create_instance(
            params["cluster_id"], params["instance_id"], params.get("instance", {})
        )
    }
...
async def _al_create_user(source: AlloyDBAdminSource, params: dict[str, Any]) -> dict[str, Any]:
    """创建AlloyDB的用户。"""
    return {
        "result": await source.create_user(
            params["cluster_id"], params["user_id"], params.get("user", {})
        )
    }


async def _al_wait_for_operation(
    source: AlloyDBAdminSource, params: dict[str, Any]
) -> dict[str, Any]:
    """等待AlloyDB的for操作完成。"""
...
class AlloyDBGenericTool(BaseTool):
    ...
    async def invoke(
        ...
        source = await _get_typed_source_async(
            source_provider, self._source_name, self.name, AlloyDBAdminSource
        )
        try:
...
_ALLOYDB_PARAMS: dict[str, list[ParameterManifest]] = {
    ...
    "alloydb-get-cluster": [
        ParameterManifest(
            name="cluster_id", type="string", description="AlloyDB cluster ID", required=True
        ),
    ],
    "alloydb-create-cluster": [
        ...
        ParameterManifest(
            name="cluster", type="object", description="Cluster configuration", required=False
        ),
    ],
    ...
    "alloydb-get-instance": [
        ...
        ParameterManifest(
            name="instance_id", type="string", description="AlloyDB instance ID", required=True
        ),
    ],
    "alloydb-create-instance": [
        ...
        ParameterManifest(
            name="instance", type="object", description="Instance configuration", required=False
        ),
    ],
    "alloydb-list-users": [
        ParameterManifest(
    ...
    "alloydb-get-user": [
        ...
        ParameterManifest(
            name="user_id", type="string", description="AlloyDB user ID", required=True
        ),
    ],
    "alloydb-create-user": [
        ParameterManifest(
        ...
        ParameterManifest(
            name="user", type="object", description="User configuration", required=False
        ),
    ],
    "alloydb-wait-for-operation": [
        ParameterManifest(
            name="operation_name",
            type="string",
            description="Operation name to wait for",
            required=True,
        ),
    ],
}
